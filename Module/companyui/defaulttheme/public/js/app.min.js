    ...
    if (typeof d3 != 'undefined') {
        $(function () {
            var defs = d3.select("defs")
                , createGradientPrimary = defs.append("linearGradient").attr("id", "gradient-primary").attr("x1", "0%").attr("y1", "100%").attr("x2", "100%").attr("y2", "0%");
            createGradientPrimary.append("stop").attr("offset", "0%").attr("style", "stop-color:" + app.colors.gradientPrimaryStart).attr("stop-opacity", 1),
                createGradientPrimary.append("stop").attr("offset", "100%").attr("style", "stop-color:" + app.colors.gradientPrimaryStop).attr("stop-opacity", 1)
        }),
            $(function () {
                var defs = d3.select("defs")
                    , createGradientSuccess = defs.append("linearGradient").attr("id", "gradient-success").attr("x1", "0%").attr("y1", "100%").attr("x2", "100%").attr("y2", "0%");
                createGradientSuccess.append("stop").attr("offset", "0%").attr("style", "stop-color:" + app.colors.gradientSuccessStart).attr("stop-opacity", 1),
                    createGradientSuccess.append("stop").attr("offset", "100%").attr("style", "stop-color:" + app.colors.gradientSuccessStop).attr("stop-opacity", 1)
            }),
            $(function () {
                var defs = d3.select("defs")
                    , createGradientInfo = defs.append("linearGradient").attr("id", "gradient-info").attr("x1", "0%").attr("y1", "100%").attr("x2", "100%").attr("y2", "0%");
                createGradientInfo.append("stop").attr("offset", "0%").attr("style", "stop-color:" + app.colors.gradientInfoStart).attr("stop-opacity", 1),
                    createGradientInfo.append("stop").attr("offset", "100%").attr("style", "stop-color:" + app.colors.gradientInfoStop).attr("stop-opacity", 1)
            }),
            $(function () {
                var defs = d3.select("defs")
                    , createGradientWarning = defs.append("linearGradient").attr("id", "gradient-warning").attr("x1", "0%").attr("y1", "100%").attr("x2", "100%").attr("y2", "0%");
                createGradientWarning.append("stop").attr("offset", "0%").attr("style", "stop-color:" + app.colors.gradientWarningStart).attr("stop-opacity", 1),
                    createGradientWarning.append("stop").attr("offset", "100%").attr("style", "stop-color:" + app.colors.gradientWarningStop).attr("stop-opacity", 1)
            }),
            $(function () {
                var defs = d3.select("defs")
                    , createGradientDanger = defs.append("linearGradient").attr("id", "gradient-danger").attr("x1", "0%").attr("y1", "100%").attr("x2", "100%").attr("y2", "0%");
                createGradientDanger.append("stop").attr("offset", "0%").attr("style", "stop-color:" + app.colors.gradientDangerStart).attr("stop-opacity", 1),
                    createGradientDanger.append("stop").attr("offset", "100%").attr("style", "stop-color:" + app.colors.gradientDangerStop).attr("stop-opacity", 1)
            });
    }
            ...
            $(".side-nav .side-nav-menu li a").on("click", function (e) {
                ...
                $(".sidenav-expand-toggler").on("click", function (e) {
                    if ($(".side-nav-backdrop").length)
                        ...
                        $(".app").append('<div class="side-nav-backdrop"></div>')
                    }
        ...
        quickView.init = function () {
            $(".quick-view-toggler").on("click", function (e) {
                if ($(".quick-view-backdrop").length)
                    ...
                    $(".app").append('<div class="quick-view-backdrop"></div>')
                }
